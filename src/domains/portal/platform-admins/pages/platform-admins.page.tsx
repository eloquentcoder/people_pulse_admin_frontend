        ...
        <DialogContent className="max-w-xl">
          ...
          <div className="space-y-3">
            <div className="max-h-64 space-y-2 overflow-y-auto rounded-md border p-3">
              ...
              )) : <p className="text-sm text-slate-500">No custom platform roles available.</p>}
            </div>
          </div>
          <DialogFooter><Button variant="outline" onClick={() => setRoleEditorAdmin(null)}>Cancel</Button><Button className="bg-[#4469e5] text-white" disabled={updating} onClick={saveRoleEditor}>Save roles</Button></DialogFooter>
        </DialogContent>
      </Dialog>
