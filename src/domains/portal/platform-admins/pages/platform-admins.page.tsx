...
import { KeyRound, Mail, Plus, ShieldCheck, UserRound, UserRoundX } from 'lucide-react'
...
import { useGetPlatformAdminsQuery, useCreatePlatformAdminMutation, useInvitePlatformAdminMutation, useUpdatePlatformAdminMutation } from '../apis/platform-admins.api'
    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-slate-500">Create operators, assign their working brief, and keep privileged access visible.</p>
        </div>
